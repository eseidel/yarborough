 ...
 * (empty when the hand is the dealer) and the vulnerability ("None" when the
 * fourth element is absent).
 */
export type SaycExpectation =
  | readonly [hand: string, expectedCall: string]
  | readonly [hand: string, expectedCall: string, history: string]
  | readonly [
      hand: string,
      expectedCall: string,
      history: string,
...
export const saycExpectations: Record<string, readonly SaycExpectation[]> = {
  test_open_one_nt: [
  ...
  test_open_two_nt: [["KQ4.AQ8.AK873.K2", "2N"]],
