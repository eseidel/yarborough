import type { Deal, Hand, Card, SuitName, RankName, CallHistory, CallInterpretation } from './types';
...
export function randomDeal(): Deal {
  ...
  const hands: Hand[] = [{ cards: [] }, { cards: [] }, { cards: [] }, { cards: [] }];
...
export const MOCK_INTERPRETATIONS: CallInterpretation[] = [
  ...
  { call: { type: 'bid', level: 1, strain: 'C' }, ruleName: 'Opening 1\u2663', description: '12-21 HCP, 3+ clubs' },
  { call: { type: 'bid', level: 1, strain: 'D' }, ruleName: 'Opening 1\u2666', description: '12-21 HCP, 3+ diamonds' },
  { call: { type: 'bid', level: 1, strain: 'H' }, ruleName: 'Opening 1\u2665', description: '12-21 HCP, 5+ hearts' },
  { call: { type: 'bid', level: 1, strain: 'S' }, ruleName: 'Opening 1\u2660', description: '12-21 HCP, 5+ spades' },
  { call: { type: 'bid', level: 1, strain: 'N' }, ruleName: 'Opening 1NT', description: '15-17 HCP, balanced' },
  { call: { type: 'bid', level: 2, strain: 'C' }, ruleName: 'Strong 2\u2663', description: '22+ HCP or 9+ tricks' },
];
